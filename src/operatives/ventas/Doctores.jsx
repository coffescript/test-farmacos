...
const Doctores = ({ cerrarModalDoctor, setDoctor }) => {
	...
	let busquedaContinua = async () => {
		if (texto.length) {
			let URL = `https://farmacontrolbackend.peacsa.com/api/auth/doctores/dynamicSearch?value=${texto}`;
	...
	return ( 
		...
		<ModalHeader style={{display: 'block'}}>
			<h3>Buscar doctor
			<span style={{float: 'right'}} onClick={cerrarModalDoctor}>x</span>
			</h3>
		</ModalHeader>
