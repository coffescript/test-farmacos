...
const url="https://farmacontrolbackend.peacsa.com/api/auth/proveedores";
				...
				<Modal isOpen={this.state.modalInsertar}>
					...
					<ModalBody>
						<div className="form-group">
							...
							<input className="form-control" type="text" name="razon_social" id="razon_social" onChange={this.handleChange} value={form?form.razon_social: ''}/>
